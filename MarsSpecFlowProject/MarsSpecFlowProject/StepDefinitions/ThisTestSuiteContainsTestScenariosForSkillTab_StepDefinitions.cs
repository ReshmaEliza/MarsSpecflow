...
namespace MarsSpecFlowProject.StepDefinitions
{
    ...
    [Binding]
    public class ThisTestSuiteContainsTestScenariosForSkillTab_StepDefinitions : BaseClass
    {
        ...
        private SkillsWorkFlow feature;
        private string tab;
        ...
        {
            //Assertions.InitChoice(tab);
            Assertions.StringLengthAssertion_Skill();
